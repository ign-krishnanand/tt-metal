...
class TTWindowAttention(nn.Module):  
    ...
    def forward(self, input_tensor, mask=None):  
        ...
        output_tensor = ttnn.to_layout(output_tensor, layout=ttnn.ROW_MAJOR_LAYOUT, memory_config=ttnn.DRAM_MEMORY_CONFIG)  
        ...
        ttnn.deallocate(proj_weight)  
        ttnn.deallocate(proj_bias)           
