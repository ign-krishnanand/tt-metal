...
def window_partition_padding(x, window_size):
    """
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        if self.shift_size > 0:
            ...
            mask_windows, pad_hw = window_partition_padding(
    ...
    def forward(self, x):
        ...
        # partition windows
        x_windows, pad_hw = window_partition_padding(shifted_x, self.window_size)  # nW*B, window_size, window_size, C
