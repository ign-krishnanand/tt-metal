...
def create_window_attention_preprocessor(device):  
    def custom_preprocessor(torch_model, name, ttnn_module_args):  
        ...
        if hasattr(torch_model, 'qkv'):  # WindowAttention model  
            ...
            relative_position_bias = torch_model.relative_position_bias_table[torch_model.relative_position_index.view(-1)].view(  
...
@pytest.mark.parametrize("input_shape, window_size, num_heads", (
        ((49, 49, 96), (7, 7), 3),
        # ((49, 49, 96), (7, 7), 8),
        # ((49, 49, 192), (7, 7), 24),
        # ((49, 49, 120), (7, 7), 5),
...
def test_window_attn(input_shape, window_size, num_heads):
    ...
    parameters = preprocess_model_parameters(
        initialize_model=lambda: ref_layer, custom_preprocessor=create_window_attention_preprocessor(device), device=device
    )
