...
#             # Layer norm 1  
#             parameters["norm1"] = {  
#                 "weight": ttnn.from_torch(model.norm1.weight, dtype=ttnn.bfloat16, device=device),  
#                 "bias": ttnn.from_torch(model.norm1.bias, dtype=ttnn.bfloat16, device=device)  
#             }  
              
#             # QKV linear layer  
#             parameters["qkv"] = {  
#                 "weight": ttnn.from_torch(model.qkv.weight.T, dtype=ttnn.bfloat16, device=device),  
#                 "bias": ttnn.from_torch(model.qkv.bias, dtype=ttnn.bfloat16, device=device) if model.qkv.bias is not None else None  
#             }  
              
#             # Relative position bias table  
#             parameters["relative_position_bias_table"] = ttnn.from_torch(  
#                 model.relative_position_bias_table, dtype=ttnn.bfloat16, device=device  
#             )  
              
#             # Output projection  
#             parameters["proj"] = {  
#                 "weight": ttnn.from_torch(model.proj.weight.T, dtype=ttnn.bfloat16, device=device),  
#                 "bias": ttnn.from_torch(model.proj.bias, dtype=ttnn.bfloat16, device=device)  
#             }  
              
#             # Layer norm 2  
#             parameters["norm2"] = {  
#                 "weight": ttnn.from_torch(model.norm2.weight, dtype=ttnn.bfloat16, device=device),  
#                 "bias": ttnn.from_torch(model.norm2.bias, dtype=ttnn.bfloat16, device=device)  
#             }  
              
#             # MLP parameters  
#             parameters["mlp"] = {  
#                 "fc1": {  
#                     "weight": ttnn.from_torch(model.mlp.fc1.weight.T, dtype=ttnn.bfloat16, device=device),  
#                     "bias": ttnn.from_torch(model.mlp.fc1.bias, dtype=ttnn.bfloat16, device=device)  
#                 },  
#                 "fc2": {  
#                     "weight": ttnn.from_torch(model.mlp.fc2.weight.T, dtype=ttnn.bfloat16, device=device),  
#                     "bias": ttnn.from_torch(model.mlp.fc2.bias, dtype=ttnn.bfloat16, device=device)  
#                 }  
#             }  
#         return parameters  
...
def create_ocab_preprocessor(device):  
    ...
    def custom_preprocessor(model, name):  
        ...
        if isinstance(model, OCAB):  
            ...
            parameters["norm1"] = {  
                "weight": ttnn.from_torch(norm1_weight, dtype=ttnn.bfloat16, layout=ttnn.ROW_MAJOR_LAYOUT, device=device),  
            ...
            parameters["qkv"] = {  
                ...
                "bias": ttnn.from_torch(model.qkv.bias, dtype=ttnn.bfloat16, layout=ttnn.TILE_LAYOUT, device=device) if model.qkv.bias is not None else None  
            }  
            ...
            parameters["norm2"] = {  
                "weight": ttnn.from_torch(norm2_weight, dtype=ttnn.bfloat16, layout=ttnn.ROW_MAJOR_LAYOUT, device=device),  
            ...
            parameters["mlp"] = {  
                "fc1": {  
                    "weight": ttnn.from_torch(model.mlp.fc1.weight.T, dtype=ttnn.bfloat16, layout=ttnn.TILE_LAYOUT, device=device),  
                    "bias": ttnn.from_torch(model.mlp.fc1.bias, dtype=ttnn.bfloat16, layout=ttnn.TILE_LAYOUT, device=device)  
                },  
                "fc2": {  
                    "weight": ttnn.from_torch(model.mlp.fc2.weight.T, dtype=ttnn.bfloat16, layout=ttnn.TILE_LAYOUT, device=device),  
                    "bias": ttnn.from_torch(model.mlp.fc2.bias, dtype=ttnn.bfloat16, layout=ttnn.TILE_LAYOUT, device=device)  
                }  
            }  
        return parameters  
    return custom_preprocessor

@pytest.mark.parametrize("dim, input_resolution, window_size, overlap_ratio, num_heads, input_shape",   
...
def test_ocab(dim, input_resolution, window_size, overlap_ratio, num_heads, input_shape):  
    ...
    try:  
        parameters = preprocess_model_parameters(  
            ...
            custom_preprocessor=create_ocab_preprocessor(device),   
            device=device  
        )  
