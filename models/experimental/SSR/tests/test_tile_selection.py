...
@pytest.mark.parametrize("image_size, patch_size, token_size, num_cls", [  
...
def test_tile_selection(image_size, patch_size, token_size, num_cls):  
    ...
    try:  
        ...
        assert overall_pass, f"TileSelection test failed - Scale 3: {does_pass_3}, Scale 2: {does_pass_2}, Scale 1: {does_pass_1}"  
